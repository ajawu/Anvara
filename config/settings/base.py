...
# anvara_assessment/
APPS_DIR = BASE_DIR / "anvara_assessment"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "anvara_assessment.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "anvara_assessment.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""David Ajawu""", "ajawudavid@gmail.com")]
